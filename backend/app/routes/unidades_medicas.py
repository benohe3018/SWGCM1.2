...
@unidades_medicas_bp.route('/api/unidades_medicina_familiar', methods=['GET'])
def get_unidades():
    try:
...
@unidades_medicas_bp.route('/api/unidades_medicina_familiar', methods=['POST'])
def create_unidad():
...
@unidades_medicas_bp.route('/api/unidades_medicina_familiar/<int:id>', methods=['PUT'])
...
@unidades_medicas_bp.route('/api/unidades_medicina_familiar/<int:id>', methods=['DELETE'])
