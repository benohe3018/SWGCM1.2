  ...
  return (
    <div className="create-usuario-page">
      ...
      <div className="Button-ir-atras-inicio">
        <button className="create-usuario-buttons" onClick={handleGoBack}>Ir Atrás</button>
        <button className="create-usuario-buttons" onClick={handleExit}>Ir a Inicio</button>
      </div>
