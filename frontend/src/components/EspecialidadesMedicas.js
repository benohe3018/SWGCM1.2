...
const EspecialidadesMedicas = ({ vistaInicial }) => {
    ...
    const handleCrearEspecialidad = async (nuevaEspecialidad) => {
        try {
            ...
            setError("No se pudo crear la especialidad médica. Por favor, intente de nuevo.");
        }
    };
    ...
    const handleEditarEspecialidad = async (especialidadEditada) => {
        try {
            ...
            setError("No se pudo editar la especialidad médica. Por favor, intente de nuevo.");
        }
    };
    ...
    const confirmarEliminarEspecialidad = async () => {
        try {
            ...
            setError("No se pudo eliminar la especialidad médica. Por favor, intente de nuevo.");
        }
    };
    ...
    if (cargando) {
        return <div>Cargando especialidades médicas...</div>;
    }
                                            ...
                                            <td>
                                                <input
                                                    ...
                                                    onChange={(e) => {
                                                        ...
                                                        const index = newEspecialidades.findIndex(es => es.id === especialidad.id);
