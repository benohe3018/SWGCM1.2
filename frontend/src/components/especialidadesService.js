...
export const createEspecialidad = async (especialidad) => {
    try {
        const response = await axios.post(`${API_URL}/api/especialidades`, especialidad);
        return response.data;
    } catch (error) {
...
export const updateEspecialidad = async (id, especialidad) => {
    try {
        const response = await axios.put(`${API_URL}/api/especialidades/${id}`, especialidad);
        return response.data;
    } catch (error) {
...
export const deleteEspecialidad = async (id) => {
    try {
        const response = await axios.delete(`${API_URL}/api/especialidades/${id}`);
        return response.data;
    } catch (error) {
